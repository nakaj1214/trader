...
| forward validation / 自己改善学習 | `src/evaluation/inflection_forward.py`, `src/evaluation/inflection_backtest.py`, `src/evaluation/inflection_portfolio.py`, `src/evaluation/inflection_learning.py` |
